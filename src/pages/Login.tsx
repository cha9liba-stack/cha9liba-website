...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 text-sm">Connectez-vous a votre espace Palma</p>
          </div>
      ...
      {/* Right: Car image with green overlay */}
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-10">
          ...
          <p className="text-white/90 text-base max-w-xs">
            Decouvrez notre flotte et profitez d'une experience de location exceptionnelle
          </p>
        </div>
      </div>
